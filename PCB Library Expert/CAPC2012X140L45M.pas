...
Procedure CreateComponentCAPC2012X140L45M(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp.Name := 'CAPC2012X140L45M';
        NewPCBLibComp.Description := 'Capacitor, Chip; 2.00 mm L X 1.25 mm W X 1.40 mm H body';
        NewPCBLibComp.Height := MMsToCoord(1.4);

        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -0.995, 0, 0, 0, eRoundedRectangular, 1.28, 1.52, 180, 39.06, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, 0.995, 0, 0, 0, eRoundedRectangular, 1.28, 1.52, 0, 39.06, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -1.08, -0.7, -1.08, 0.7, eMechanical11, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.08, 0.7, 1.08, 0.7, eMechanical11, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.08, 0.7, 1.08, -0.7, eMechanical11, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.08, -0.7, -1.08, -0.7, eMechanical11, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1, 0.985, -1, 0.985, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 1, -0.985, -1, -0.985, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -2.14, -1.26, -2.14, 1.26, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -2.14, 1.26, 2.14, 1.26, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 2.14, 1.26, 2.14, -1.26, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 2.14, -1.26, -2.14, -1.26, eMechanical15, 0.05, False);
...
Begin
    ...
    CreateComponentCAPC2012X140L45M(0);
