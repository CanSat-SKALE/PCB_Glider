...
Procedure CreateComponentCAP_0603(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp.Name := 'CAP_0603';
        NewPCBLibComp.Description := 'Capacitor, Chip; 1.60 mm L X 0.80 mm W X 0.90 mm H body';
        NewPCBLibComp.Height := MMsToCoord(0.9);

        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -0.745, 0, 0, 0, eRoundedRectangular, 0.94, 0.93, 180, 49.46, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, 0.745, 0, 0, 0, eRoundedRectangular, 0.94, 0.93, 0, 49.46, 0, 0, True, True);
