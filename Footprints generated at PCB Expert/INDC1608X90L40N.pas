...
Procedure CreateComponentINDC1608X90L40N(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp.Name := 'INDC1608X90L40N';
        NewPCBLibComp.Description := 'Inductor, Chip; 1.60 mm L X 0.80 mm W X 0.90 mm H body';
        NewPCBLibComp.Height := MMsToCoord(0.9);

        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -0.76, 0, 0, 0, eRoundedRectangular, 0.91, 0.93, 180, 50.55, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, 0.76, 0, 0, 0, eRoundedRectangular, 0.91, 0.93, 0, 50.55, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -0.85, -0.45, -0.85, 0.45, eMechanical11, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -0.85, 0.45, 0.85, 0.45, eMechanical11, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 0.85, 0.45, 0.85, -0.45, eMechanical11, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 0.85, -0.45, -0.85, -0.45, eMechanical11, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 0.8, 0.645, -0.8, 0.645, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 0.8, -0.645, -0.8, -0.645, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.47, -0.72, -1.47, 0.72, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.47, 0.72, 1.47, 0.72, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.47, 0.72, 1.47, -0.72, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.47, -0.72, -1.47, -0.72, eMechanical15, 0.05, False);
...
Begin
    ...
    CreateComponentINDC1608X90L40N(0);
